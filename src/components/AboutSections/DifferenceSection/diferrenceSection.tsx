          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center justify-center sm:justify-start">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex flex-col items-center justify-center px-6 py-6 sm:px-8 sm:py-8 w-[160px] sm:w-[180px] transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 cursor-default bg-[#223872] text-white hover:bg-[#BB1717] shadow-lg"
              >
                {feature.icon}
